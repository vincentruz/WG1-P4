...
## 4.	Generate Model Plots (for each Course)

### a.	For each subject, add column of fitted values; then combine disciplines into single dataframe for viz
``` {r include = FALSE}
# Load libraries
if (!require("pacman")) install.packages("pacman")
library(pacman)
...
```{r}
#Combine disciplines into onee dataframe for viz
...
### b. Build interactive viz using RShiny package
