...
summary(m1.a_bio)
exp(cbind("Odds Ratio" = coef(m1.a_bio), confint.default(m1.a_bio, level = 0.95)))
...
summary(m1.a_chem)   
exp(cbind("Odds Ratio" = coef(m1.a_chem), confint.default(m1.a_chem, level = 0.95)))
...
summary(m1.a_phys)
exp(cbind("Odds Ratio" = coef(m1.a_phys), confint.default(m1.a_phys, level = 0.95)))
