...
#Bio
m1.c_BY <- glm(eligible_to_skip ~ factor(firstgen) + factor(lowincomflag)  + factor(female) + factor(urm) +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               binomial(link = "logit"), df_bio2)
summary(m1.c_BY)
...
#Chem
m1.c_CH <- glm(eligible_to_skip ~ factor(firstgen) + factor(lowincomflag)  + factor(female) + factor(urm) +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               binomial(link = "logit"), df_chem2)
summary(m1.c_CH)   
...
#Physics
# Skip w/ CE or CM
m1.c_PH <- glm(eligible_to_skip ~ factor(firstgen) + factor(lowincomflag) + factor(female) + factor(urm) +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               binomial(link = "logit"), df_phys2)
summary(m1.c_PH)   
...
#### RQ2 ####
# Model 2a: skipped_course if eligible ####
#Bio
m2.a_BY <- glm(skipped_course ~ factor(firstgen) + factor(lowincomflag)  + factor(female) + factor(urm) +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
...
describe(df_BYeligible$skipped_course)

#Chem
m2.a_CH <- glm(skipped_course ~ factor(firstgen) + factor(lowincomflag)  + factor(female) + factor(urm) +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
...
describe(df_CHeligible$skipped_course)

#Physics
# Skip w/ CE or CM
m2.a_PH <- glm(skipped_course ~ factor(firstgen) + factor(lowincomflag) + factor(female) + factor(urm) +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort),
...
describe(df_PHeligible$skipped_course)

# Grade in second course if took AP?
# Model 2b: Grade for AP takers ####
#Bio
m2.b_BY <- lm(scale(numgrade_2) ~ skipped_course + scale(apscore) + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_BYtakers)
summary(m2.b_BY)
...
#Bio eligible
m2.b.el_BY <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                   scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
                 df_BYeligible)
summary(m2.b.el_BY)
...
#Bio if apscore=4
m2.b4_BY <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               df_BYeligible.4)
summary(m2.b4_BY)
...
#Bio if apscore=5
m2.b5_BY <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               df_BYeligible.5)
summary(m2.b5_BY)
...
#Chem
m2.b_CH <- lm(scale(numgrade_2) ~ skipped_course + scale(apscore) + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_CHtakers)
summary(m2.b_CH)
...
#Chem eligible
m2.b.el_CH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                   scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
                 df_CHeligible)
summary(m2.b.el_CH)
...
#Chem if apscore = 3
m2.b3_CH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               df_CHeligible.3)
summary(m2.b3_CH)
...
#Chem if apscore = 4
m2.b4_CH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               df_CHeligible.4)
summary(m2.b4_CH)
...
#Chem if apscore = 5
m2.b5_CH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               df_CHeligible.5)
summary(m2.b5_CH)
...
#Phys
m2.b_PH <- lm(scale(numgrade_2) ~ skipped_course + scale(apscore) + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_PHtakers)
summary(m2.b_PH)
...
#Phys eligible
m2.b.el_PH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                   scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
                 df_PHeligible)
summary(m2.b.el_PH)
...
#Phys if PH = 5
m2.b5_PH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                 scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
               df_PHeligible.5)
summary(m2.b5_PH)
...
#Bio
m2.c_BY <- lm(scale(numgrade_2) ~ skipped_course + scale(apscore_full) + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_bio2)
summary(m2.c_BY)
...
#Chem
m2.c_CH <- lm(scale(numgrade_2) ~ skipped_course + scale(apscore_full) + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_bio2)
summary(m2.c_CH)
...
#Phys
m2.c_PH <- lm(scale(numgrade_2) ~ skipped_course + scale(apscore_full) + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_phys2)
summary(m2.c_PH)
cbind("Beta" = coef(m2.c_PH), confint.default(m2.c_PH, level = 0.95))

# Model 2d: Grade for AP takers (c.skipped_course, no score)####
#Bio
m2.d_BY <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_BYtakers)
summary(m2.d_BY)
...
#Chem
m2.d_CH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_CHtakers)
summary(m2.d_CH)
...
#Phys
m2.d_PH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_PHtakers)
summary(m2.d_PH)
cbind("Beta" = coef(m2.d_PH), confint.default(m2.d_PH, level = 0.95))

# Model 2e: Grade for everyone (c.skipped_course, no score) ####
#Bio
m2.e_BY <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_bio2)
summary(m2.e_BY)
...
#Chem
m2.e_CH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_chem2)
summary(m2.e_CH)
...
#Phys
m2.e_PH <- lm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_phys2)
summary(m2.e_PH)
...
#Bio
m2.f_BY <- lm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_BYtakers)
summary(m2.f_BY)
...
#Chem
m2.f_CH <- lm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_CHtakers)
summary(m2.f_CH)
...
#Phys
m2.f_PH <- lm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_PHtakers)
summary(m2.f_PH)
...
#Bio
m2.g_BY <- lm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_bio2)
summary(m2.g_BY)
...
#Chem
m2.g_CH <- lm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_chem2)
summary(m2.g_CH)
...
#Phys
m2.g_PH <- lm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag)  + female + urm +
                scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), 
              df_phys2)
summary(m2.g_PH)
...
df_bio2_comp <- df_bio2 %>%  
  select(numgrade_2, apscore_full, eligible_to_skip, skipped_course, firstgen, lowincomflag, female, urm, 
         hsgpa, mathsr, englsr, enrl_from_cohort) %>%
  filter(complete.cases(.))

# Check balance before weighting
bal.tab(skipped_course ~ + firstgen + factor(lowincomflag) + female + urm +
          scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort),
        data = df_bio2_comp, estimand = "ATT", m.threshold = .05)

# Estimate weights
bio.out <- weightit(skipped_course ~ firstgen + factor(lowincomflag) + female + urm +
                      scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort),
...
# Estimate weights
chem.out <- weightit(skipped_course ~ firstgen + factor(lowincomflag) + female + urm +
                       scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort),
...
# Estimate weights
phys.out <- weightit(skipped_course ~ firstgen + factor(lowincomflag) + female + urm +
                       scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort),
...
#Bio
m2e.2_BY <- svyglm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag) + female + urm +
...
#Chem
m2e.2_CH <- svyglm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag) + female + urm +
...
#Phys
m2e.2_PH <- svyglm(scale(numgrade_2) ~ skipped_course + firstgen + factor(lowincomflag) + female + urm +
...
#Bio
m2g.2_BY <- svyglm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag) + female + urm +
                     scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), design = bio.w)
summary(m2g.2_BY)
...
#Chem
m2g.2_CH <- svyglm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag) + female + urm +
                     scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), design = chem.w)
summary(m2g.2_CH)
...
#Phys
m2e.2_PH <- svyglm(scale(numgrade_2) ~ eligible_to_skip + firstgen + factor(lowincomflag) + female + urm +
                     scale(hsgpa) + scale(mathsr) + scale(englsr) + factor(enrl_from_cohort), design = phys.w)
summary(m2e.2_PH)
cbind("Beta" = coef(m2e.2_PH), confint.default(m2e.2_PH, level = 0.95))
...
bio.psm <- glm(skipped_course ~ female + englsr + mathsr + apscore,
...
df_bio2_psm <- data.frame(pr_score = predict(bio.psm, type = "response"),
                          skipped_course = bio.psm$model$skipped_course)

# Matched dataset (no missing)
df_bio2_nomiss <- df_bio2 %>%  
  select(numgrade_2, apscore, skipped_course, one_of(AP_cov)) %>%
  na.omit()

bio_matched <- matchit(skipped_course ~ female + englsr + mathsr + apscore,
...
# Estimate propensity score
gchem.psm <- glm(skipped_course ~ female + englsr + mathsr + apscore,
                 family = binomial(), data = df_chem2)

# Create dataframe with propensity scores
df_gchem2_psm <- data.frame(pr_score = predict(gchem.psm, type = "response"),
                            skipped_course = gchem.psm$model$skipped_course)

# Matched dataset (no missing)
df_gchem2_nomiss <- df_chem2 %>%  
  select(numgrade_2, apscore, skipped_course, one_of(AP_gchem_cov)) %>%
  na.omit()

gchem_matched <- matchit(skipped_course ~ female + englsr + mathsr + apscore,
...
# Estimate propensity score
phys.psm <- glm(skipped_course ~ female + englsr + mathsr + apscore,
                family = binomial(), data = df_phys2)

# Create dataframe with propensity scores
df_phys2_psm <- data.frame(pr_score = predict(phys.psm, type = "response"),
                           skipped_course = phys.psm$model$skipped_course)
...
phys_matched <- matchit(skipped_course ~ female + englsr + mathsr + apscore,
